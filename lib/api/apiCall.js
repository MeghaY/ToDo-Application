...
//Also add the rest api endpoint which you cna get access to using nconf.get() from sample.json or development.json for making any change to the parse objects
...
exports.deleteTodo = function(req,res){
  console.log('Todo ObjectId: '+ req.query.todoId);
  request.del({
...
//  console.log('body: '+ JSON.stringify(data));
  ...
  request.put({
    url: nconf.get('parse:apiEndPoint') + '/todos/'+ req.body.todoId,
    encoding: null,
    headers: {
      'X-Parse-Application-Id': nconf.get('parse:appId'),
      'X-Parse-REST-API-Key': nconf.get('parse:restKey'),
